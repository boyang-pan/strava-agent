        ...
        <TooltipProvider>
          <div className="space-y-3">
            ...
            <Tooltip>
                ...
                <div className="flex items-center gap-4 rounded-xl border border-zinc-100 dark:border-zinc-800/50 p-4 opacity-50 cursor-not-allowed select-none">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] px-1.5 py-0.5 rounded-full border border-zinc-200 dark:border-zinc-700 text-zinc-400 dark:text-zinc-600 leading-none whitespace-nowrap">
                        Planned
                      </span>
                    </div>
              ...
              <TooltipContent>Garmin Connect integration is planned for a future release</TooltipContent>
            </Tooltip>
            ...
            <Tooltip>
              ...
              <TooltipContent>Apple Health integration is planned for a future release</TooltipContent>
            </Tooltip>
          </div>
        </TooltipProvider>
      </div>
